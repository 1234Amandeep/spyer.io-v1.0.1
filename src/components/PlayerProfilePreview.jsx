  ...
  const addToWishlist = async () => {
    ...
    if (!isExists) {
      ...
      if (user) {
        ...
        const res = await fetch("http://localhost:3000/addToWishlist", {
          method: "POST",
        ...
        <div className="player-profile-preview ">
          {isLoading ? (
            ...
            <p className="text-center text-danger ">
              <u>
                Sorry could'nt find what you were looking for... Please try
                something else like: ronaldo
              </u>
            </p>
          ) : (
            <article
